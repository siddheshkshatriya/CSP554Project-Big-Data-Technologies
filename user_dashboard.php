...
foreach ($cursor as $document) {
    echo "<tr>
            <td>{$document->prd_name}</td>
            <td>{$document->prd_code}</td>
            <td>{$document->prd_inventory}</td>
            <td>{$document->prd_cost}</td>
            <td>
                <div class='btn-group m-r-12'>
                    ...
                    <ul role='menu' class='dropdown-menu'>    
                        <li><a href='edit.php?id={$document->prd_code}'>Edit</a></li>
                        <li><a href='remove.php?id={$document->prd_code}'>Remove Item</a></li>
                        <li><a href='add_item.php?id={$document->prd_code}'>Add Item</a></li>
                        <li><a href='delete.php?id={$document->prd_code}'>Delete Product</a></li>
                    </ul>
                </div>
            </td>
          </tr>";
